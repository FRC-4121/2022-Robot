...
public class AutoTurnUntilSeeBall extends CommandBase {
  ...
  //figure out which way direction takes you. Basically when the rest of the field is on the robot's left, then it would make more sense to rotate there. vice versa. 
  ...
  public void execute() {
    ...
    if (!foundBall) {
      ...
      drivetrain.autoDrive(speedCorrection * direction * kAutoDriveSpeed + angleCorrection * direction, speedCorrection * direction*kAutoDriveSpeed - angleCorrection * direction);
    } else {
    ...
    SmartDashboard.putNumber("Left motor Speed while turning", speedCorrection * direction * kAutoDriveSpeed + angleCorrection * direction);
    SmartDashboard.putNumber("Right Motor Speed while turning",speedCorrection * direction*kAutoDriveSpeed - angleCorrection * direction);

  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) { drivetrain.stopDrive(); }
